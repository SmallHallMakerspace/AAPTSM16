...
\begin{frame}[label=summary]{Summary}
 ...
 \begin{block}{The PIPELINE Network\footnotemark{} (includes George Washington University)}
  ...
  \end{itemize}
 \end{block}
  \footnotetext{This material is based in part upon work supported by the National Science Foundation's Improving Undergraduate STEM Education (IUSE) program under Award No. 1624882.}
\end{frame}
